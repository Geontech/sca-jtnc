...
import os as _os
from sca.cf import CF as _CF
from sca.cf import CF__POA as _CF__POA
#from sca.cf import ExtendedCF as _ExtendedCF
...
from sca.utils import idllib
from sca.utils.model import _Port
from sca.utils.model import _readProfile
from sca.utils.model import _idllib
from sca.utils.model import ConnectionManager as _ConnectionManager
from sca.utils.model import *
from sca.utils.log_helpers import stringToCode
from sca.utils.notify import notification
from sca.utils import weakobj
...
from sca.utils.model import QueryableBase
...
class EventChannelManager(CorbaObject):
    ...
    def registerConsumer(self, consumer, req):
        '''
           consumer is an event consumer (i.e.: sca.events.Receiver)
    ...
    def registerPublisher(self, req, disconnectReceiver):
        '''
           req is an EventRegistration (i.e.: CF.EventRegistration)
           disconnectReceiver is an optional event consumer (i.e.: sca.events.Receiver)
        '''
