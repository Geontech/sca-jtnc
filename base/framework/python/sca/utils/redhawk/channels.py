...
from sca.cf import StandardEvent, CF
from sca import events
from sca.utils.uuid import uuid4
...
class IDMListener(ChannelListener):
    ...
    EVENT_MAP = { StandardEvent.IDLE          : CF.CapacityManagement.IDLE,
                  StandardEvent.ACTIVE        : CF.CapacityManagement.ACTIVE,
                  StandardEvent.BUSY          : CF.CapacityManagement.BUSY,
                  StandardEvent.LOCKED        : CF.AdministratableInterface.LOCKED,
                  StandardEvent.UNLOCKED      : CF.AdministratableInterface.UNLOCKED,
                  StandardEvent.SHUTTING_DOWN : CF.AdministratableInterface.SHUTTING_DOWN }
