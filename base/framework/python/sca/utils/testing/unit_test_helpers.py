...
import sca.parsers.spd as SPDParser
import sca.parsers.prf as PRFParser
import sca.parsers.scd as SCDParser
import logging
...
import getopt
from sca.properties import mapComplexType
from sca.utils.prop_helpers import parseComplexString
...
#        unittest.TestCase.__init__(self)
    ...
    def launch(self, execparams={}, scahome=None, configure={}, initialize=True, objType=None, debugger=None):
        """
       ...
       """
        if IDE_REF_ENV == None:
            if scahome:
                ...
                model._idllib.addSearchPath(str(scahome)+'/idl')
