...
from sca import properties as core_properties
from sca.utils import prop_helpers
from sca.utils.model import _DEBUG
from sca.utils.model import *
from sca.utils.model.connect import ConnectionManager
from sca.utils.uuid import uuid4

from sca.utils.sandbox import LocalSandbox, IDESandbox
import sca.utils.sandbox
...
def generateSADXML(waveform_name):
    ...
    '''
    import sca.utils.redhawk.sad_template as sad_template
    if _DEBUG == True:
