...
import sca.utils.bulkio.bulkio_helpers as _bulkio_helpers
from sca.utils.bluefile import bluefile_helpers
from sca.utils.bulkio import bulkio_data_helpers
import sca.utils.bluefile.bluefile as _bluefile
from sca import properties as _properties
from sca import events as _events
...
from sca.utils.model import PortSupplier, OutputBase
from sca.utils.model.connect import ConnectionManager
...
class DataSourceSDDS(_SourceBase):
    ...
    def getData( self, mgroup, hostip, port=29495, pkts=1000, pktlen=1080, block=True, returnSddsAnalyzer=True):
        ...
        if returnSddsAnalyzer:
            from sca.utils.sdds import SDDSAnalyzer
