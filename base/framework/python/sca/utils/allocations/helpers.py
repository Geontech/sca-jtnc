...
def matchTypes(props, prop_ids=[], prf=None):
    ...
    parsedPrf = sca.parsers.prf.parseString(prfcontents)
    classes = {}
    ...
    for _prop in props:
        ...
        if isinstance(classes[_prop.id], sca.parsers.prf.simple) or isinstance(classes[_prop.id], sca.parsers.prf.simpleSequence):
