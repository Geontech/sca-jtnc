...
from sca.utils.model import CorbaObject
from sca.utils.model import PortSupplier, PropertySet, ComponentBase
from sca.utils.model import Resource, Device, Service

from sca.utils.sandbox.events import EventChannel
...
class SandboxResource(ComponentBase, SandboxMixin):
    ...
    def sendMessage(self, msg, msgId=None, msgPort=None, restrict=True ):
        ...
        if self._msgSupplierHelper == None:
            import sca.utils
            self._msgSupplierHelper = sca.utils.sb.io_helpers.MsgSupplierHelper(self)
