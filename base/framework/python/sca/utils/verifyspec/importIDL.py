...
from sca.utils.idl import omniidl
from omniidl import idlast, idlvisitor, idlutil, main, idltype
from sca.utils.idl import _omniidl
import os
import threading
...
def importStandardIdl(std_idl_path='/usr/local/share/idl/sca', std_idl_include_path = '/usr/local/share/idl'):
    ...
    cfdir = os.path.join(std_idl_path, "sca/CF")
