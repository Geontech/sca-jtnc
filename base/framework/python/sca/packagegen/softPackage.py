...
class SoftPackage(object):
    ...
    def callCodegen(self, force = False, variant = ""):
        """
        Format command line arguments and call sca-codegen.

        For example:

            $ sca-codegen -m foo1.m -m foo2.m -f /home/user/bar.spd.xml

        """
        self._preCodegen()

        codegenArgs = ["sca-codegen"]
    ...
    def _createWavedevContent(self, generator):
        ...
        self.wavedevContent+='<codegen:WaveDevSettings xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:codegen="http://www.jtnc.gov/model/codegen">\n'
        self.wavedevContent+='<implSettings key="__IMPLEMENTATION">\n'
        self.wavedevContent+='<value outputDir="__IMPLEMENTATION" template="sca.codegen.jinja.__GENERATOR" generatorId="sca.codegen.jinja.__GENERATOR" primary="true"/>\n'
