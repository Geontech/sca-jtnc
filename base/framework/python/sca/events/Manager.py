...
#from  sca.cf.CF import EventChannelManager
from  sca.events  import Publisher
from  sca.events  import Subscriber
...
class Manager:
    ...
    def __init__(self, resource=None ):
        ...
        self._ecm = None
        self._logger = logging.getLogger("sca.events.Manager")
    ...
    def GetManager( resource ):
        if Manager._manager == None :
            try:
                ...
                #print traceback.format_exc()
                logging.getLogger("sca.events.Manager").warn("Unable to resolve Event Manager")
