...
from sca.utils import redhawk,prop_helpers

from properties import *
from browsewindowbase import BrowseWindowBase
import installdialog as installdialog
from sca.utils.redhawk.channels import IDMListener, ODMListener
from sca.utils import weakobj
import sca.parsers.sad
import Queue
...
class BrowseWindow(BrowseWindowBase):
    ...
    def _getSADName (self, sadFile):
        try:
            ...
            try:
                sad = sca.parsers.sad.parseString(f.read(f.sizeOf()))
                return sad.name
            finally:
                f.close()
        except:
