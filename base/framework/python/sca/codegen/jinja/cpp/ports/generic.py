...
from sca.codegen.lang.idl import IDLInterface, IDLStruct
...
class GenericPortGenerator(CppPortGenerator):
    ...
    def dependencies(self):
        return ['<boost/thread/locks.hpp>', '<sca/Port_impl.h>', '<sca/debug.h>', cpp.idlHeader(self.idl)]
...
class GenericUsesPortGenerator(GenericPortGenerator):
    def dependencies(self):
        ...
        deps = ['<vector>', '<utility>', '<sca/CF/QueryablePort.h>']
