...
bool sca::compare_anys(const CORBA::Any& a, const CORBA::Any& b, std::string& action) {
...
CORBA::Any sca::convertComplexStringToAny(std::string value) {
 ...
 */
CORBA::Any sca::calculateDynamicProp(double operand, CORBA::Any& prop, std::string& math, CORBA::TCKind resultKind)
{
 ...
 */
CORBA::Any sca::stringToComplexAny(std::string value, std::string structName) {
    CORBA::Any result;
 ...
 */
CORBA::Any sca::stringToSimpleAny(std::string value, CORBA::TCKind kind) {
    CORBA::Any result;
    char *endptr = NULL;
    std::string _type;
    ...
    if (endptr != NULL) {
        if ((value != "(null)") and ((endptr == value.c_str()) or (*endptr != '\0'))) {
            ...
            throw sca::badConversion(value, _type);
        }
    }
    return result;
}
 ...
 * by struct name.
 */
CORBA::Any sca::string_to_any(std::string value, CORBA::TypeCode_ptr type)
{
    CORBA::Any result;
    ...
    if (type->kind() == CORBA::tk_struct) {
        ...
        if (structName == std::string("UTCTime")) {
            result <<= sca::time::utils::convert(value);
        } else {
...
CORBA::Any sca::strings_to_any(const std::vector<std::string>& values, CORBA::TCKind kind)
{
    return strings_to_any(values, kind, NULL);
}

CORBA::Any sca::strings_to_any(const std::vector<std::string>& values, CORBA::TCKind kind, CORBA::TypeCode_ptr type)
{
    CORBA::Any result;
    if (type != NULL) {
        if (type->kind() == CORBA::tk_struct) {
...
std::string sca::convertComplexAnyToString(const CORBA::Any& value){
...
std::string sca::complexAnyToString(const CORBA::Any& value)
{
    std::string result;
...
std::string sca::simpleAnyToString(const CORBA::Any& value)
{
    std::ostringstream result;
...
std::string sca::any_to_string(const CORBA::Any& value)
{
    std::string result;

    CORBA::TypeCode_var valueType = value.type();
    if (valueType->equivalent(CF::_tc_Properties)) {
        result = sca::Value::cast(value).asProperties().toString();
...
std::vector<std::string> sca::any_to_strings(const CORBA::Any& value)
{
...
CORBA::Any::from_boolean sca::strings_to_boolean(const std::vector<std::string> &values)
{
...
CORBA::Any::from_char sca::strings_to_char(const std::vector<std::string> &values)
{
    CORBA::Char result(' ');
...
CORBA::Double sca::strings_to_double(const std::vector<std::string> &values)
{
...
CORBA::Float sca::strings_to_float(const std::vector<std::string> &values)
{
...
CORBA::Short sca::strings_to_short(const std::vector<std::string> &values)
{
...
CORBA::Long sca::strings_to_long(const std::vector<std::string> &values)
{
    CORBA::Long result(0);
...
CORBA::LongLong sca::strings_to_long_long(const std::vector<std::string> &values)
{
...
CORBA::Any::from_octet sca::strings_to_octet(const std::vector<std::string> &values)
{
...
CORBA::UShort sca::strings_to_unsigned_short(const std::vector<std::string> &values)
{
...
CORBA::ULong sca::strings_to_unsigned_long(const std::vector<std::string> &values)
{
...
CORBA::String_var sca::strings_to_string(const std::vector<std::string> &values)
{
...
CORBA::BooleanSeq* sca::strings_to_boolean_sequence(const std::vector<std::string> &values)
{
...
CF::complexBooleanSeq* sca::strings_to_complex_boolean_sequence(const std::vector<std::string> &values)
{
...
CORBA::CharSeq* sca::strings_to_char_sequence(const std::vector<std::string> &values)
{
...
CF::complexCharSeq* sca::strings_to_complex_char_sequence(const std::vector<std::string> &values)
{
...
CORBA::DoubleSeq* sca::strings_to_double_sequence(const std::vector<std::string> &values)
{
...
CF::complexDoubleSeq* sca::strings_to_complex_double_sequence(const std::vector<std::string> &values)
{
...
CORBA::FloatSeq* sca::strings_to_float_sequence(const std::vector<std::string> &values)
{
...
CF::complexFloatSeq* sca::strings_to_complex_float_sequence(const std::vector<std::string> &values)
{
...
CORBA::ShortSeq* sca::strings_to_short_sequence(const std::vector<std::string> &values)
{
...
CF::complexShortSeq* sca::strings_to_complex_short_sequence(const std::vector<std::string> &values)
{
...
CORBA::LongSeq* sca::strings_to_long_sequence(const std::vector<std::string> &values)
{
...
CF::complexLongSeq* sca::strings_to_complex_long_sequence(const std::vector<std::string> &values)
{
...
CORBA::LongLongSeq* sca::strings_to_long_long_sequence(const std::vector<std::string> &values)
{
...
CF::complexLongLongSeq* sca::strings_to_complex_long_long_sequence(const std::vector<std::string> &values)
{
...
CORBA::ULongLongSeq* sca::strings_to_unsigned_long_long_sequence(const std::vector<std::string> &values)
{
...
CF::complexULongLongSeq* sca::strings_to_complex_unsigned_long_long_sequence(const std::vector<std::string> &values)
{
...
CORBA::OctetSeq* sca::strings_to_octet_sequence(const std::vector<std::string> &values)
{
...
CF::complexOctetSeq* sca::strings_to_complex_octet_sequence(const std::vector<std::string> &values)
{
...
CORBA::UShortSeq* sca::strings_to_unsigned_short_sequence(const std::vector<std::string> &values)
{
...
CF::complexUShortSeq* sca::strings_to_complex_unsigned_short_sequence(const std::vector<std::string> &values)
{
...
CORBA::ULongSeq* sca::strings_to_unsigned_long_sequence(const std::vector<std::string> &values)
{
...
CF::complexULongSeq* sca::strings_to_complex_unsigned_long_sequence(const std::vector<std::string> &values)
{
...
CORBA::StringSeq* sca::strings_to_string_sequence(const std::vector<std::string> &values)
{
...
CF::UTCTimeSequence* sca::strings_to_utctime_sequence(const std::vector<std::string> &values)
{
    ...
    for (unsigned int i = 0; i < values.size(); ++i) {
        result[i] = sca::time::utils::convert(values[i].c_str());
    }
 ...
 */
CORBA::TCKind sca::getTypeKind(std::string type) {
    CORBA::TCKind kind;
    if (type == "boolean") {
...
CORBA::TypeCode_ptr sca::getTypeCode(std::string type) {
 ...
 */
CORBA::TypeCode_ptr sca::getTypeCode(CORBA::TCKind kind, std::string structName) {
...
CF::Properties sca::getNonNilProperties(const CF::Properties& originalProperties)
{
    sca::PropertyMap nonNilProperties;
    const sca::PropertyMap& properties = sca::PropertyMap::cast(originalProperties);

    for (sca::PropertyMap::const_iterator prop = properties.begin(); prop != properties.end(); ++prop) {
...
CF::Properties sca::getNonNilConfigureProperties(const CF::Properties& originalProperties)
{
