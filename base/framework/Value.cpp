...
Value::Type Value::GetType(CORBA::TypeCode_ptr typecode)
{
    ...
    // Remove any aliases
    CORBA::TypeCode_var base_type = sca::corba::unalias(typecode);
...
{
    CORBA::TypeCode_var any_type = type();
    any_type = sca::corba::unalias(any_type);
...
{
    return sca::any_to_string(*this);
}

bool Value::toBoolean() const
{
    return sca::any::toBoolean(*this);
}

float Value::toFloat() const
{
    return sca::any::toFloat(*this);
}

double Value::toDouble() const
{
    return sca::any::toDouble(*this);
}

CORBA::Octet Value::toOctet() const
{
    return sca::any::toOctet(*this);
}

CORBA::Short Value::toShort() const
{
    return sca::any::toShort(*this);
}

CORBA::UShort Value::toUShort() const
{
    return sca::any::toUShort(*this);
}

CORBA::Long Value::toLong() const
{
    return sca::any::toLong(*this);
}

CORBA::ULong Value::toULong() const
{
    return sca::any::toULong(*this);
}

CORBA::LongLong Value::toLongLong() const
{
    return sca::any::toLongLong(*this);
}

CORBA::ULongLong Value::toULongLong() const
{
    return sca::any::toULongLong(*this);
}

bool Value::isNil() const
{
    return sca::any::isNull(*this);
}
...
std::ostream& sca::operator<<(std::ostream& out, const CORBA::Any& value)
{
...
{
    sca::corba::push_back(*this, value);
}
