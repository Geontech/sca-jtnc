...
namespace sca {
    namespace detail {
        // Bring sca::internal::has_equals into this namespace (in effect) so
        // we can specialize it for boost::bind
        template <class T>
        struct has_equals : public sca::internal::has_equals<T> { };
        ...
        template <class Target, class Func>
        inline typename boost::enable_if<sca::internal::has_equals<Target>,bool>::type
...
namespace sca {
    ...
    {
        typedef ::sca::detail::invoker<R(A1)> invoker_type;
    ...
    {
        typedef ::sca::detail::invoker<R(A1,A2)> invoker_type;
    ...
    {
    public:
        typedef sca::callback<Signature> func_type;
