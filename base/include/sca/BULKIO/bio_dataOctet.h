...
#ifndef __bio__dataOctet_hh__
#define __bio__dataOctet_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
#endif
...
#ifndef __BULKIO_mdataOctet__
#define __BULKIO_mdataOctet__
  class dataOctet;
  class _objref_dataOctet;
  class _impl_dataOctet;
  
  typedef _objref_dataOctet* dataOctet_ptr;
  typedef dataOctet_ptr dataOctetRef;

  class dataOctet_Helper {
  public:
    typedef dataOctet_ptr _ptr_type;
  ...
  typedef _CORBA_ObjRef_Var<_objref_dataOctet, dataOctet_Helper> dataOctet_var;
  typedef _CORBA_ObjRef_OUT_arg<_objref_dataOctet,dataOctet_Helper > dataOctet_out;
  ...
  public:
    ...
    typedef dataOctet_ptr _ptr_type;
    typedef dataOctet_var _var_type;
  ...
  public:
    ...
    // Constructors
    inline _objref_dataOctet()  { _PR_setobj(0); }  // nil
    _objref_dataOctet(omniIOR*, omniIdentity*);

  protected:
    virtual ~_objref_dataOctet();

    
  private:
    virtual void* _ptrToObjRef(const char*);

    _objref_dataOctet(const _objref_dataOctet&);
    _objref_dataOctet& operator = (const _objref_dataOctet&);
    // not implemented

    friend class dataOctet;
  };

  class _pof_dataOctet : public _OMNI_NS(proxyObjectFactory) {
  public:
    inline _pof_dataOctet() : _OMNI_NS(proxyObjectFactory)(dataOctet::_PD_repoId) {}
    virtual ~_pof_dataOctet();
  ...
  {
  public:
    virtual ~_impl_dataOctet();

    virtual void pushPacket(const ::CF::OctetSequence& data, const ::BULKIO::PrecisionUTCTime& T, ::CORBA::Boolean EOS, const char* streamID) = 0;
  ...
  _CORBA_MODULE_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_dataOctet;
...
_CORBA_MODULE_BEG
  ...
  class dataOctet :
    public virtual BULKIO::_impl_dataOctet,
  ...
  public:
    ...
    inline ::BULKIO::dataOctet_ptr _this() {
      return (::BULKIO::dataOctet_ptr) _do_this(::BULKIO::dataOctet::_PD_repoId);
    }
  };
...
void operator<<=(::CORBA::Any& _a, BULKIO::dataOctet_ptr _s);
void operator<<=(::CORBA::Any& _a, BULKIO::dataOctet_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, BULKIO::dataOctet_ptr& _s);



inline void
BULKIO::dataOctet::_marshalObjRef(::BULKIO::dataOctet_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}



#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataOctet
#endif

#endif  // __bio__dataOctet_hh__
