...
#ifndef __bio__dataUlong_hh__
#define __bio__dataUlong_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
#endif
...
#ifndef __BULKIO_mdataUlong__
#define __BULKIO_mdataUlong__
  class dataUlong;
  class _objref_dataUlong;
  class _impl_dataUlong;
  
  typedef _objref_dataUlong* dataUlong_ptr;
  typedef dataUlong_ptr dataUlongRef;

  class dataUlong_Helper {
  public:
    typedef dataUlong_ptr _ptr_type;
  ...
  typedef _CORBA_ObjRef_Var<_objref_dataUlong, dataUlong_Helper> dataUlong_var;
  typedef _CORBA_ObjRef_OUT_arg<_objref_dataUlong,dataUlong_Helper > dataUlong_out;
  ...
  public:
    ...
    typedef dataUlong_ptr _ptr_type;
    typedef dataUlong_var _var_type;
  ...
  public:
    ...
    // Constructors
    inline _objref_dataUlong()  { _PR_setobj(0); }  // nil
    _objref_dataUlong(omniIOR*, omniIdentity*);

  protected:
    virtual ~_objref_dataUlong();

    
  private:
    virtual void* _ptrToObjRef(const char*);

    _objref_dataUlong(const _objref_dataUlong&);
    _objref_dataUlong& operator = (const _objref_dataUlong&);
    // not implemented

    friend class dataUlong;
  };

  class _pof_dataUlong : public _OMNI_NS(proxyObjectFactory) {
  public:
    inline _pof_dataUlong() : _OMNI_NS(proxyObjectFactory)(dataUlong::_PD_repoId) {}
    virtual ~_pof_dataUlong();
  ...
  {
  public:
    virtual ~_impl_dataUlong();

    virtual void pushPacket(const ::PortTypes::UlongSequence& data, const ::BULKIO::PrecisionUTCTime& T, ::CORBA::Boolean EOS, const char* streamID) = 0;
  ...
  _CORBA_MODULE_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_dataUlong;
...
_CORBA_MODULE_BEG
  ...
  class dataUlong :
    public virtual BULKIO::_impl_dataUlong,
  ...
  public:
    ...
    inline ::BULKIO::dataUlong_ptr _this() {
      return (::BULKIO::dataUlong_ptr) _do_this(::BULKIO::dataUlong::_PD_repoId);
    }
  };
...
void operator<<=(::CORBA::Any& _a, BULKIO::dataUlong_ptr _s);
void operator<<=(::CORBA::Any& _a, BULKIO::dataUlong_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, BULKIO::dataUlong_ptr& _s);



inline void
BULKIO::dataUlong::_marshalObjRef(::BULKIO::dataUlong_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}



#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataUlong
#endif

#endif  // __bio__dataUlong_hh__
