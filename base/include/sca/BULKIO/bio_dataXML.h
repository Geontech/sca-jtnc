...
#ifndef __bio__dataXML_hh__
#define __bio__dataXML_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
#endif
...
#ifndef __BULKIO_mdataXML__
#define __BULKIO_mdataXML__
  class dataXML;
  class _objref_dataXML;
  class _impl_dataXML;
  
  typedef _objref_dataXML* dataXML_ptr;
  typedef dataXML_ptr dataXMLRef;

  class dataXML_Helper {
  public:
    typedef dataXML_ptr _ptr_type;
  ...
  typedef _CORBA_ObjRef_Var<_objref_dataXML, dataXML_Helper> dataXML_var;
  typedef _CORBA_ObjRef_OUT_arg<_objref_dataXML,dataXML_Helper > dataXML_out;
  ...
  public:
    ...
    // Constructors
    inline _objref_dataXML()  { _PR_setobj(0); }  // nil
    _objref_dataXML(omniIOR*, omniIdentity*);

  protected:
    virtual ~_objref_dataXML();

    
  private:
    virtual void* _ptrToObjRef(const char*);

    _objref_dataXML(const _objref_dataXML&);
    _objref_dataXML& operator = (const _objref_dataXML&);
    // not implemented

    friend class dataXML;
  };

  class _pof_dataXML : public _OMNI_NS(proxyObjectFactory) {
  public:
    inline _pof_dataXML() : _OMNI_NS(proxyObjectFactory)(dataXML::_PD_repoId) {}
    virtual ~_pof_dataXML();
  ...
  {
  public:
    virtual ~_impl_dataXML();

    virtual void pushPacket(const char* xml_string, ::CORBA::Boolean EOS, const char* streamID) = 0;
  ...
  _CORBA_MODULE_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_dataXML;
...
_CORBA_MODULE_BEG
  ...
  class dataXML :
    public virtual BULKIO::_impl_dataXML,
  ...
  public:
    ...
    inline ::BULKIO::dataXML_ptr _this() {
      return (::BULKIO::dataXML_ptr) _do_this(::BULKIO::dataXML::_PD_repoId);
    }
  };
...
void operator<<=(::CORBA::Any& _a, BULKIO::dataXML_ptr _s);
void operator<<=(::CORBA::Any& _a, BULKIO::dataXML_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, BULKIO::dataXML_ptr& _s);



inline void
BULKIO::dataXML::_marshalObjRef(::BULKIO::dataXML_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}



#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataXML
#endif

#endif  // __bio__dataXML_hh__
