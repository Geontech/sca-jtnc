...
#ifndef __bio__dataDouble_hh__
#define __bio__dataDouble_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
#endif
...
#ifndef __BULKIO_mdataDouble__
#define __BULKIO_mdataDouble__
  class dataDouble;
  class _objref_dataDouble;
  class _impl_dataDouble;
  
  typedef _objref_dataDouble* dataDouble_ptr;
  typedef dataDouble_ptr dataDoubleRef;

  class dataDouble_Helper {
  public:
    typedef dataDouble_ptr _ptr_type;
  ...
  typedef _CORBA_ObjRef_Var<_objref_dataDouble, dataDouble_Helper> dataDouble_var;
  typedef _CORBA_ObjRef_OUT_arg<_objref_dataDouble,dataDouble_Helper > dataDouble_out;

#endif

  // interface dataDouble
  class dataDouble {
  public:
    // Declarations for this interface type.
    typedef dataDouble_ptr _ptr_type;
    typedef dataDouble_var _var_type;
  ...
  public:
    ...
    // Constructors
    inline _objref_dataDouble()  { _PR_setobj(0); }  // nil
    _objref_dataDouble(omniIOR*, omniIdentity*);

  protected:
    virtual ~_objref_dataDouble();

    
  private:
    virtual void* _ptrToObjRef(const char*);

    _objref_dataDouble(const _objref_dataDouble&);
    _objref_dataDouble& operator = (const _objref_dataDouble&);
    // not implemented

    friend class dataDouble;
  };

  class _pof_dataDouble : public _OMNI_NS(proxyObjectFactory) {
  public:
    inline _pof_dataDouble() : _OMNI_NS(proxyObjectFactory)(dataDouble::_PD_repoId) {}
    virtual ~_pof_dataDouble();
  ...
  {
  public:
    virtual ~_impl_dataDouble();

    virtual void pushPacket(const ::PortTypes::DoubleSequence& data, const ::BULKIO::PrecisionUTCTime& T, ::CORBA::Boolean EOS, const char* streamID) = 0;
  ...
  _CORBA_MODULE_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_dataDouble;
...
_CORBA_MODULE_BEG
  ...
  class dataDouble :
    public virtual BULKIO::_impl_dataDouble,
  ...
  public:
    ...
    inline ::BULKIO::dataDouble_ptr _this() {
      return (::BULKIO::dataDouble_ptr) _do_this(::BULKIO::dataDouble::_PD_repoId);
    }
  };
...
void operator<<=(::CORBA::Any& _a, BULKIO::dataDouble_ptr _s);
void operator<<=(::CORBA::Any& _a, BULKIO::dataDouble_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, BULKIO::dataDouble_ptr& _s);



inline void
BULKIO::dataDouble::_marshalObjRef(::BULKIO::dataDouble_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}



#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataDouble
#endif

#endif  // __bio__dataDouble_hh__
