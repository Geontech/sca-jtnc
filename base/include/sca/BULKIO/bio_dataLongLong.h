...
#ifndef __bio__dataLongLong_hh__
#define __bio__dataLongLong_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
#endif
...
#ifndef __BULKIO_mdataLongLong__
#define __BULKIO_mdataLongLong__
  class dataLongLong;
  class _objref_dataLongLong;
  class _impl_dataLongLong;
  
  typedef _objref_dataLongLong* dataLongLong_ptr;
  typedef dataLongLong_ptr dataLongLongRef;

  class dataLongLong_Helper {
  public:
    typedef dataLongLong_ptr _ptr_type;
  ...
  typedef _CORBA_ObjRef_Var<_objref_dataLongLong, dataLongLong_Helper> dataLongLong_var;
  typedef _CORBA_ObjRef_OUT_arg<_objref_dataLongLong,dataLongLong_Helper > dataLongLong_out;

#endif

  // interface dataLongLong
  class dataLongLong {
  public:
    // Declarations for this interface type.
    typedef dataLongLong_ptr _ptr_type;
    typedef dataLongLong_var _var_type;
  ...
  public:
    ...
    // Constructors
    inline _objref_dataLongLong()  { _PR_setobj(0); }  // nil
    _objref_dataLongLong(omniIOR*, omniIdentity*);

  protected:
    virtual ~_objref_dataLongLong();

    
  private:
    virtual void* _ptrToObjRef(const char*);

    _objref_dataLongLong(const _objref_dataLongLong&);
    _objref_dataLongLong& operator = (const _objref_dataLongLong&);
    // not implemented

    friend class dataLongLong;
  };

  class _pof_dataLongLong : public _OMNI_NS(proxyObjectFactory) {
  public:
    inline _pof_dataLongLong() : _OMNI_NS(proxyObjectFactory)(dataLongLong::_PD_repoId) {}
    virtual ~_pof_dataLongLong();
  ...
  {
  public:
    virtual ~_impl_dataLongLong();

    virtual void pushPacket(const ::PortTypes::LongLongSequence& data, const ::BULKIO::PrecisionUTCTime& T, ::CORBA::Boolean EOS, const char* streamID) = 0;
  ...
  _CORBA_MODULE_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_dataLongLong;
...
_CORBA_MODULE_BEG
  ...
  class dataLongLong :
    public virtual BULKIO::_impl_dataLongLong,
    public virtual ProvidesPortStatisticsProvider,
      public virtual updateSRI
  {
  public:
    virtual ~dataLongLong();

    inline ::BULKIO::dataLongLong_ptr _this() {
      return (::BULKIO::dataLongLong_ptr) _do_this(::BULKIO::dataLongLong::_PD_repoId);
    }
  };
...
void operator<<=(::CORBA::Any& _a, BULKIO::dataLongLong_ptr _s);
void operator<<=(::CORBA::Any& _a, BULKIO::dataLongLong_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, BULKIO::dataLongLong_ptr& _s);



inline void
BULKIO::dataLongLong::_marshalObjRef(::BULKIO::dataLongLong_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}



#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataLongLong
#endif

#endif  // __bio__dataLongLong_hh__
