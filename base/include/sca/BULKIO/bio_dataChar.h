...
#ifndef __bio__dataChar_hh__
#define __bio__dataChar_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
#endif
...
#ifndef __BULKIO_mdataChar__
#define __BULKIO_mdataChar__
  class dataChar;
  class _objref_dataChar;
  class _impl_dataChar;
  
  typedef _objref_dataChar* dataChar_ptr;
  typedef dataChar_ptr dataCharRef;

  class dataChar_Helper {
  public:
    typedef dataChar_ptr _ptr_type;
  ...
  typedef _CORBA_ObjRef_Var<_objref_dataChar, dataChar_Helper> dataChar_var;
  typedef _CORBA_ObjRef_OUT_arg<_objref_dataChar,dataChar_Helper > dataChar_out;
  ...
  public:
    ...
    typedef dataChar_ptr _ptr_type;
    typedef dataChar_var _var_type;
  ...
  public:
    ...
    // Constructors
    inline _objref_dataChar()  { _PR_setobj(0); }  // nil
    _objref_dataChar(omniIOR*, omniIdentity*);

  protected:
    virtual ~_objref_dataChar();

    
  private:
    virtual void* _ptrToObjRef(const char*);

    _objref_dataChar(const _objref_dataChar&);
    _objref_dataChar& operator = (const _objref_dataChar&);
    // not implemented

    friend class dataChar;
  };

  class _pof_dataChar : public _OMNI_NS(proxyObjectFactory) {
  public:
    inline _pof_dataChar() : _OMNI_NS(proxyObjectFactory)(dataChar::_PD_repoId) {}
    virtual ~_pof_dataChar();
  ...
  {
  public:
    virtual ~_impl_dataChar();

    virtual void pushPacket(const ::PortTypes::CharSequence& data, const ::BULKIO::PrecisionUTCTime& T, ::CORBA::Boolean EOS, const char* streamID) = 0;
  ...
  _CORBA_MODULE_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_dataChar;
...
_CORBA_MODULE_BEG
  ...
  class dataChar :
    public virtual BULKIO::_impl_dataChar,
  ...
  public:
    ...
    inline ::BULKIO::dataChar_ptr _this() {
      return (::BULKIO::dataChar_ptr) _do_this(::BULKIO::dataChar::_PD_repoId);
    }
  };
...
void operator<<=(::CORBA::Any& _a, BULKIO::dataChar_ptr _s);
void operator<<=(::CORBA::Any& _a, BULKIO::dataChar_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, BULKIO::dataChar_ptr& _s);



inline void
BULKIO::dataChar::_marshalObjRef(::BULKIO::dataChar_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}



#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataChar
#endif

#endif  // __bio__dataChar_hh__
