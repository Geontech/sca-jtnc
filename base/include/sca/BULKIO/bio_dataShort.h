...
#ifndef __bio__dataShort_hh__
#define __bio__dataShort_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
#endif
...
#ifndef __BULKIO_mdataShort__
#define __BULKIO_mdataShort__
  class dataShort;
  class _objref_dataShort;
  class _impl_dataShort;
  
  typedef _objref_dataShort* dataShort_ptr;
  typedef dataShort_ptr dataShortRef;

  class dataShort_Helper {
  public:
    typedef dataShort_ptr _ptr_type;
  ...
  typedef _CORBA_ObjRef_Var<_objref_dataShort, dataShort_Helper> dataShort_var;
  typedef _CORBA_ObjRef_OUT_arg<_objref_dataShort,dataShort_Helper > dataShort_out;
  ...
  public:
    ...
    typedef dataShort_ptr _ptr_type;
    typedef dataShort_var _var_type;
  ...
  public:
    ...
    // Constructors
    inline _objref_dataShort()  { _PR_setobj(0); }  // nil
    _objref_dataShort(omniIOR*, omniIdentity*);

  protected:
    virtual ~_objref_dataShort();

    
  private:
    virtual void* _ptrToObjRef(const char*);

    _objref_dataShort(const _objref_dataShort&);
    _objref_dataShort& operator = (const _objref_dataShort&);
    // not implemented

    friend class dataShort;
  };

  class _pof_dataShort : public _OMNI_NS(proxyObjectFactory) {
  public:
    inline _pof_dataShort() : _OMNI_NS(proxyObjectFactory)(dataShort::_PD_repoId) {}
    virtual ~_pof_dataShort();
  ...
  {
  public:
    virtual ~_impl_dataShort();

    virtual void pushPacket(const ::PortTypes::ShortSequence& data, const ::BULKIO::PrecisionUTCTime& T, ::CORBA::Boolean EOS, const char* streamID) = 0;
  ...
  _CORBA_MODULE_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_dataShort;
...
_CORBA_MODULE_BEG
  ...
  class dataShort :
    public virtual BULKIO::_impl_dataShort,
  ...
  public:
    ...
    inline ::BULKIO::dataShort_ptr _this() {
      return (::BULKIO::dataShort_ptr) _do_this(::BULKIO::dataShort::_PD_repoId);
    }
  };
...
void operator<<=(::CORBA::Any& _a, BULKIO::dataShort_ptr _s);
void operator<<=(::CORBA::Any& _a, BULKIO::dataShort_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, BULKIO::dataShort_ptr& _s);



inline void
BULKIO::dataShort::_marshalObjRef(::BULKIO::dataShort_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}



#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_bio__dataShort
#endif

#endif  // __bio__dataShort_hh__
