...
namespace sca {
    ...
    public:
         ...
         * Must not throw an exception.
         */
        virtual sca::PropertyMap getNegotiationProperties(UsesTransport*)
        {
         ...
         */         
        virtual void setNegotiationResult(UsesTransport*, const sca::PropertyMap&)
        {
        }
    };
    ...
    public:
         ...
         * Must not throw an exception.
         */
        virtual sca::PropertyMap getNegotiationProperties(ProvidesTransport*)
        {
            return sca::PropertyMap();
        }
    };
    ...
    public:
        ...
        virtual ProvidesTransportManager* createProvidesManager(sca::NegotiableProvidesPortBase* port) = 0;
        virtual UsesTransportManager* createUsesManager(sca::NegotiableUsesPort* port) = 0;
    };
