...
#include <uuid/uuid.h>
#include <sca/FRONTEND/Frontend.h>
...
namespace frontend {
    ...
    class AllocationAlreadyExists : public CF::CapacityManagement::InvalidCapacity {
      public:
    ...
    class FrontendTunerDevice : public DeviceComponent
    {
        ENABLE_LOGGING
        ...
        public:
            ...
            virtual CF::CapacityManagement::UsageType updateUsageState();
            virtual CORBA::Boolean allocateCapacity(const CF::Properties & capacities) throw (CORBA::SystemException, CF::CapacityManagement::InvalidCapacity, CF::InvalidState);
            virtual void deallocateCapacity(const CF::Properties & capacities)throw (CORBA::SystemException, CF::CapacityManagement::InvalidCapacity, CF::InvalidState);
        ...
        protected:
            ...
            void printSRI(BULKIO::StreamSRI *sri, std::string strHeader = "DEBUG SRI"){
                ...
                unsigned long keySize = sri->keywords.length();
                for (unsigned int i = 0; i < keySize; i++) {
                    std::cout << "\t KEYWORD KEY/VAL :: " << sri->keywords[i].id << ": " << sca::any_to_string(sri->keywords[i].value) << std::endl;
                }
                std::cout << std::endl;
            }
