...
namespace frontend {
     ...
     RFInfoPkt returnRFInfoPkt(const FRONTEND::RFInfoPkt &tmpVal) {
        RFInfoPkt val;
        val.rf_flow_id = sca::corba::returnString(tmpVal.rf_flow_id);
        ...
        val.sensor.collector = sca::corba::returnString(tmpVal.sensor.collector);
        val.sensor.mission = sca::corba::returnString(tmpVal.sensor.mission);
        val.sensor.rx = sca::corba::returnString(tmpVal.sensor.rx);
        val.sensor.antenna.description = sca::corba::returnString(tmpVal.sensor.antenna.description);
        val.sensor.antenna.name = sca::corba::returnString(tmpVal.sensor.antenna.name);
        val.sensor.antenna.size = sca::corba::returnString(tmpVal.sensor.antenna.size);
        val.sensor.antenna.type = sca::corba::returnString(tmpVal.sensor.antenna.type);
        val.sensor.feed.name = sca::corba::returnString(tmpVal.sensor.feed.name);
        val.sensor.feed.polarization = sca::corba::returnString(tmpVal.sensor.feed.polarization);
     ...
     frontend::GPSInfo returnGPSInfo(const FRONTEND::GPSInfo &tmpVal) {
        ...
        val.source_id = sca::corba::returnString(tmpVal.source_id);
        val.rf_flow_id = sca::corba::returnString(tmpVal.rf_flow_id);
        val.mode = sca::corba::returnString(tmpVal.mode);
        val.fom = tmpVal.fom;
        ...
        val.snr = tmpVal.snr;
        val.status_message = sca::corba::returnString(tmpVal.status_message);
     ...
     frontend::GpsTimePos returnGpsTimePos(const FRONTEND::GpsTimePos &tmpVal) {
        ...
        val.position.datum = sca::corba::returnString(tmpVal.position.datum);
    ...
    FRONTEND::NavigationPacket* returnNavigationPacket(const frontend::NavigationPacket &val) {
     ...
     frontend::NavigationPacket returnNavigationPacket(const FRONTEND::NavigationPacket &tmpVal) {
        ...
        val.cposition.datum = sca::corba::returnString(tmpVal.cposition.datum);
        ...
        val.velocity.datum = sca::corba::returnString(tmpVal.velocity.datum);
        val.velocity.coordinate_system = sca::corba::returnString(tmpVal.velocity.coordinate_system);
        ...
        val.acceleration.datum = sca::corba::returnString(tmpVal.acceleration.datum);
        val.acceleration.coordinate_system = sca::corba::returnString(tmpVal.acceleration.coordinate_system);
      ...
      void  copyRFInfoPktSequence(const RFInfoPktSequence &src, FRONTEND::RFInfoPktSequence &dest) {
        ...
        for( ; i != src.end(); i++ ) {
            sca::corba::push_back( dest, getRFInfoPkt(*i) );
        }
    }
