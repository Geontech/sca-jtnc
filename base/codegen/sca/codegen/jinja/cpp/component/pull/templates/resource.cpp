...
{
    // Avoid placing constructor code here. Instead, use the "construct" function.
${ self.ctorBody() }
}
/*{% endif %}*/
...
{
    /***********************************************************************************
     This is the construct. All properties are properly initialized before this function is called 
