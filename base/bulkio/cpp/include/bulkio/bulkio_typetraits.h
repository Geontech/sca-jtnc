...
#include <sca/BULKIO/bio_dataExt.h>
...
#undef DEFINE_CORBA_TRAITS
    ...
    struct NativeTraits<BULKIO::dataBit> {
        typedef sca::shared_bitbuffer::data_type NativeType;
    ...
    struct BufferTraits {
        ...
        typedef sca::shared_buffer<NativeType> BufferType;
        typedef sca::buffer<NativeType> MutableBufferType;
    };

    template <>
    struct BufferTraits<BULKIO::dataBit> {
        typedef sca::shared_bitbuffer VectorType;
        typedef sca::shared_bitbuffer BufferType;
        typedef sca::bitbuffer MutableBufferType;
    };
