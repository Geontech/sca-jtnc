...
namespace bulkio {
    ...
    class OutputTransport : public sca::UsesTransport
    {
    public:
    ...
    template <class PortType>
    class InputTransport : public sca::ProvidesTransport
    {
    protected:
    ...
    template <class PortType>
    class OutputManager : public sca::UsesTransportManager
    {
    public:
        typedef typename PortType::_ptr_type PtrType;
        ...
        virtual OutputTransport<PortType>* createOutputTransport(PtrType object, 
                                                                 ...
                                                                 const sca::PropertyMap& properties) = 0;
    protected:
        typedef OutPort<PortType> OutPortType;
    ...
    private:
        virtual sca::UsesTransport* createUsesTransport(CORBA::Object_ptr object,
                                                            const std::string& connectionId,
                                                            const sca::PropertyMap& properties);
    };

    template <class PortType>
    class InputManager : public sca::ProvidesTransportManager
    {
    public:
    ...
    private:
        virtual sca::ProvidesTransport* createProvidesTransport(const std::string& transportId,
                                                                    const sca::PropertyMap& properties);
    };

    template <class PortType>
    class BulkioTransportFactory : public sca::TransportFactory
    {
    public:
        typedef InPort<PortType> InPortType;
        typedef OutPort<PortType> OutPortType;
    ...
    private:
        virtual sca::ProvidesTransportManager* createProvidesManager(sca::NegotiableProvidesPortBase* port);
        virtual sca::UsesTransportManager* createUsesManager(sca::NegotiableUsesPort* port);
    };
}
