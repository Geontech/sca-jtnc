...
namespace bulkio {
    ...
    struct DataTransferBase {
        ...
        sca::PropertyMap& getKeywords()
        {
            return sca::PropertyMap::cast(SRI.keywords);
        }

        const sca::PropertyMap& getKeywords() const
        {
            return sca::PropertyMap::cast(SRI.keywords);
        }
    };
    ...
    struct DataTransfer< std::vector<NativeType> > : public DataTransferBase< std::vector<NativeType> > {
        ...
        // 
        DataTransfer(const sca::shared_buffer<NativeType>& data, const BULKIO::PrecisionUTCTime& T, bool EOS,
                     const char* streamID, const BULKIO::StreamSRI& H, bool sriChanged, bool inputQueueFlushed) :
    ...
    typedef DataTransfer<sca::shared_bitbuffer> BitDataTransfer;
}
