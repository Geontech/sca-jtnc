...
namespace bulkio {
     ...
     * becomes:
     * @code
     *   const sca::shared_buffer<float> buffer = block.buffer();
     ...
     * @code
     *   if (block.complex()) {
     *     const sca::shared_buffer<std::complex<float> > buffer = block.cxbuffer();
     ...
     */
    template <class T>
    class SampleDataBlock : public DataBlock<sca::shared_buffer<T> >
    {
    public:
    ...
    typedef DataBlock<sca::shared_bitbuffer> BitDataBlock;
