...
namespace bulkio {
    ...
    public:
         ...
         * @pre  Stream is valid.
         * @see  setKeyword(const std::string&, const sca::Value&)
         ...
         * write.
         */
        void setKeyword(const std::string& name, const sca::Value& value);

        /**
         * @brief  Sets the current value of a keyword in the SRI.
         * @param name  The name of the keyword.
         * @param value  The new value.
         * @tparam T  Any type that can be converted to a sca::Value.
         * @pre  Stream is valid.
         *
         * If the keyword @a name already exists, its value is updated to
         * @a value. If the keyword @a name does not exist, the new keyword is
        ...
        {
            setKeyword(name, sca::Value(value));
        }
    ...
    public:
        ...
        typedef sca::shared_buffer<ScalarType> ScalarBuffer;
        /// @brief  The shared_buffer type for complex data.
        typedef sca::shared_buffer<ComplexType> ComplexBuffer;
    ...
    private:
        ...
        inline void _writeMultiple(const sca::shared_buffer<Sample>& data,
