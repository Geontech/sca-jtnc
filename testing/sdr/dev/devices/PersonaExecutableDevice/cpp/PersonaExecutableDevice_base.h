...
#ifndef PERSONAEXECUTABLEDEVICE_IMPL_BASE_H
#define PERSONAEXECUTABLEDEVICE_IMPL_BASE_H
...
class PersonaExecutableDevice_base;
...
class PersonaExecutableDevice_base : public ExecutableDeviceComponent, protected ThreadedComponent
{
    public:
        ...
        PersonaExecutableDevice_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev);
        PersonaExecutableDevice_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities);
        PersonaExecutableDevice_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev);
    ...
    protected:
        ProcessThread<PersonaExecutableDevice_base> *serviceThread; 
