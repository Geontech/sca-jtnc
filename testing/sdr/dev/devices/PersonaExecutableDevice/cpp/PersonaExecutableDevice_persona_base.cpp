...
PREPARE_LOGGING(PersonaExecutableDevice_persona_base)

PersonaExecutableDevice_persona_base::PersonaExecutableDevice_persona_base (
                        char            *devMgr_ior, 
                        char            *id, 
                        char            *lbl, 
                        char            *sftwrPrfl ) 
:
    PersonaExecutableDevice_base(devMgr_ior, id, lbl, sftwrPrfl),
...
PersonaExecutableDevice_persona_base::PersonaExecutableDevice_persona_base (
                        ...
                        char            *compDev ) 
:
    PersonaExecutableDevice_base(devMgr_ior, id, lbl, sftwrPrfl, compDev),
    _previousRequestProps()
{
    construct();
}
...
:
    PersonaExecutableDevice_base(devMgr_ior, id, lbl, sftwrPrfl, capacities),
    _previousRequestProps()
{
    construct();
}
...
PersonaExecutableDevice_persona_base::PersonaExecutableDevice_persona_base (
                        ...
                        char            *compDev ) 
:
    PersonaExecutableDevice_base(devMgr_ior, id, lbl, sftwrPrfl, capacities, compDev),
    _previousRequestProps()
{
    construct();
}

void PersonaExecutableDevice_persona_base::construct() 
{
...
void PersonaExecutableDevice_persona_base::adminState(CF::AdministratableInterface::AdminType adminState) 
    throw (CORBA::SystemException)
{
    ...
    PersonaExecutableDevice_base::adminState(adminState);
}

void PersonaExecutableDevice_persona_base::releaseObject() 
    throw (
        ...
        CORBA::SystemException ) 
{
    ...
    // SR:419
    LOG_DEBUG(PersonaExecutableDevice_persona_base, __FUNCTION__ << ": Receive releaseObject call");
...
CORBA::Boolean PersonaExecutableDevice_persona_base::attemptToProgramParent() 
{
...
CORBA::Boolean PersonaExecutableDevice_persona_base::attemptToUnprogramParent() 
{
    // Return false if there is no reference to the parent
    if (_parentDevice == NULL) {
        return false;
...
void PersonaExecutableDevice_persona_base::formatRequestProps(
