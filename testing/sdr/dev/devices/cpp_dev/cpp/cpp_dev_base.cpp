...
*******************************************************************************************/
void cpp_dev_base::start() throw (CORBA::SystemException, CF::ControllableInterface::StartError)
{
    DeviceComponent::start();
    ThreadedComponent::startThread();
}

void cpp_dev_base::stop() throw (CORBA::SystemException, CF::ControllableInterface::StopError)
{
