...
from sca.parsers import DCDParser
from sca.properties import simple_property
from sca.resource import usesport
...
def spawnNodeBooter(dmdFile=None, 
    ...
    print '-------------------------------------------------------------------'
    nb = sca.utils.Popen(args, cwd=getSdrPath(), shell=False, preexec_fn=os.setpgrp, stderr=stderr)
    if DEBUG_NODEBOOTER:
